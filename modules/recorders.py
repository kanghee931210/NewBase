...
class Recorder():
    ...
    def save_plot(self, plots: list):
        ...
        color_list = ['red', 'blue','yellow','green','purple','pink','cyan',
                      'indigo','orange','navy', 'teal', 'peru']  # train, val

        for plot_name in plots:
            if plot_name == 'acc':
                columns = [f'train_{plot_name}', f'val_{plot_name}','train_acc_d','train_acc_g','train_acc_e',
                           'val_acc_d','val_acc_g','val_acc_e']
            elif plot_name == 'lr':
